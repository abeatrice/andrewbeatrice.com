                    ...
                    <div class="mt-6 md:mt-10 lg:mt-16 flex justify-center">
                        <div class="grid sm:grid-flow-row sm:grid-cols-2 sm:grid-rows-4 lg:grid-cols-4 lg:grid-rows-2 gap-4 md:gap-16">
                            ...
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 256 134">
                                    <g fill-rule="evenodd">
                            ...
                            <!-- Laravel -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center fill-current text-red-500" viewBox="0 0 256 256">
                            ...
                            <!-- Symfony -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 256 256">
                            ...
                            <!-- MySql -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 150 150">
                            ...
                            <!-- JS -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 630 630">
                            ...
                            <!-- Vue -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 256 221">
                            ...
                            <!-- Redis -->
                            <div class="flex flex-col justify-center items-center flex-shrink-0">
                                <svg class="h-64 w-64 self-center" viewBox="0 0 256 220">
